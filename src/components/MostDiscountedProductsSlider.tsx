...
function MostDiscountedProductsSlider() {
    ...
    const products = useFindManyAndCountProductsQuery({
        ...
        query: {
            queryKey: getFindManyAndCountProductsQueryQueryKey({ limit: 12, skip: 0, discount: "DESC" }),
...
export default MostDiscountedProductsSlider